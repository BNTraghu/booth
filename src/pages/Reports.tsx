    ...
    <div className="space-y-6">
      ...
      {activeTab === 'overview' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              <h3 className="text-lg font-semibold text-gray-900">Top Performing Societies</h3>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {[
                  { name: 'Sunset Heights Society', events: 12, revenue: 345000, growth: 25.4 },
                  { name: 'Green Valley Residency', events: 10, revenue: 298000, growth: 18.7 },
                  { name: 'Royal Gardens Complex', events: 8, revenue: 234000, growth: 15.2 },
                  { name: 'Paradise Towers', events: 6, revenue: 187000, growth: 12.8 }
                ].map((society, index) => (
                  <div key={society.name} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">{society.events} events</div>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="font-medium text-gray-900">₹{(society.revenue / 1000).toFixed(0)}K</div>
                      <div className="text-sm text-green-600">+{society.growth}%</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <CardContent>
              <div className="space-y-4">
                {[
                  ...
                  { name: 'Society Engagement Analysis', type: 'Society', lastGenerated: '2024-05-28', format: 'Dashboard' },
