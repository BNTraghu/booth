...
const navigation: NavItem[] = [
  ...
  { name: 'Societies', href: '/societies', icon: Building2, roles: ['super_admin', 'admin', 'sales_marketing'] },
  ...
  return (
    <div className="flex h-full w-64 flex-col bg-gray-900">
      <div className="flex h-16 items-center justify-between bg-gray-800 px-4">
        <h1 className="text-lg sm:text-xl font-bold text-white">Society Events</h1>
        {/* Mobile close button */}
        <button
          onClick={onClose}
